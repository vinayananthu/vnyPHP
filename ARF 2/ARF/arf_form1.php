...
<div id="main_div">
	...
	<form name="myform" enctype="multipart/form-data" method="post">
        ...
        <table cellspacing="0" cellpadding="5" border="0" width="100%" id="pi1_tb">
            ...
            <tr>
            	<td><b>Email</b></td>
				<td colspan="5"><input type="text" style="width: 99%" name="email" placeholder="xyz@latech.edu" id="email" <? if($edit==1 || $csv_input==1) echo " value=\"$email\""; ?> onBlur="check_previous_forms('email')"></td>
            </tr>
            <tr  bgcolor="#F1F1F1">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="dob" placeholder="mm/dd/yyyy" id="datepicker2" class="dp"<? if($edit==1 || $csv_input==1) echo " value=\"$dob\""; ?>>
                </td>
            ...
            <tr>
                ...
                <td>
                	<select name="dept">
                    	...
                    	<!--
						<option value="1" <?php if($edit==1 && $dept==1) echo 'selected';?>>PRESIDENT'S OFFICE - 009</option>
						<option value="2" <?php if($edit==1 && $dept==2) echo 'selected';?>>ACADEMIC AFFAIRS - 010</option>
						<option value="3" <?php if($edit==1 && $dept==3) echo 'selected';?>>ADMINISTRATIVE AFFAIRS - 012</option>
						<option value="4" <?php if($edit==1 && $dept==4) echo 'selected';?>>STUDENT AFFAIRS - 014</option>
						<option value="5" <?php if($edit==1 && $dept==5) echo 'selected';?>>APPLIED &amp; NATURAL SCIENCES - ADM. - 015</option>
						<option value="6" <?php if($edit==1 && $dept==6) echo 'selected';?>>APPLIED &amp; NATUAL SCIENCES - 016</option>
						<option value="7" <?php if($edit==1 && $dept==7) echo 'selected';?>>HEALTH INFORMATION - 017</option>
						<option value="8" <?php if($edit==1 && $dept==8) echo 'selected';?>>LIBERAL ARTS - 018</option>
						<option value="9" <?php if($edit==1 && $dept==9) echo 'selected';?>>INTERNAL AUDIT - 019</option>
						<option value="10" <?php if($edit==1 && $dept==10) echo 'selected';?>>COLLEGE OF BUSINESS - 020</option>
						<option value="11" <?php if($edit==1 && $dept==11) echo 'selected';?>>EDUCATION - 022</option>
						<option value="12" <?php if($edit==1 && $dept==12) echo 'selected';?>>ENGINEERING - 024</option>
						<option value="13" <?php if($edit==1 && $dept==13) echo 'selected';?>>HUMAN ECOLOGY - 026</option>
						<option value="14" <?php if($edit==1 && $dept==14) echo 'selected';?>>UNIVERSITY RESEARCH - 027</option>
						<option value="15" <?php if($edit==1 && $dept==15) echo 'selected';?>>GRADUATE SCHOOL - 028</option>
						<option value="16" <?php if($edit==1 && $dept==16) echo 'selected';?>>CONTINUING EDUCATION - 029</option>
						<option value="17" <?php if($edit==1 && $dept==17) echo 'selected';?>>AFROTC - 030</option>
						<option value="18" <?php if($edit==1 && $dept==18) echo 'selected';?>>BARKSDALE - 031</option>
						<option value="19" <?php if($edit==1 && $dept==19) echo 'selected';?>>BOOKSTORE (BARNES &amp; NOBLE) - 032</option>
						<option value="20" <?php if($edit==1 && $dept==20) echo 'selected';?>>BUILDINGS &amp; GROUNDS - 034</option>
						<option value="21" <?php if($edit==1 && $dept==21) echo 'selected';?>>PURCHASING - 036</option>
						<option value="22" <?php if($edit==1 && $dept==22) echo 'selected';?>>TELECOMMUNICATIONS - 038</option>
						<option value="23" <?php if($edit==1 && $dept==23) echo 'selected';?>>COMPTROLLER - 040</option>
						<option value="24" <?php if($edit==1 && $dept==24) echo 'selected';?>>COMPUTING CENTER - 042</option>
						<option value="25" <?php if($edit==1 && $dept==25) echo 'selected';?>>ENVIRONMENTAL - 046</option>
						<option value="26" <?php if($edit==1 && $dept==26) echo 'selected';?>>ATHLETICS - 048</option>
						<option value="27" <?php if($edit==1 && $dept==27) echo 'selected';?>>HUMAN RESOURCES - 052</option>
						<option value="28" <?php if($edit==1 && $dept==28) echo 'selected';?>>LIBRARY - 054</option>
						<option value="29" <?php if($edit==1 && $dept==29) echo 'selected';?>>NEWS BUREAU - 058</option>
						<option value="30" <?php if($edit==1 && $dept==30) echo 'selected';?>>UNIVERSITY POLICE - 060</option>
						<option value="31" <?php if($edit==1 && $dept==31) echo 'selected';?>>UNIVERSITY ADVANCEMENT - 062</option>
						<option value="32" <?php if($edit==1 && $dept==32) echo 'selected';?>>POST OFFICE/ OFFICE SVCS. - 064</option>
						<option value="33" <?php if($edit==1 && $dept==33) echo 'selected';?>>PROPERTY - 066</option>
						<option value="34" <?php if($edit==1 && $dept==34) echo 'selected';?>>REGISTRAR - 068</option>
						<option value="35" <?php if($edit==1 && $dept==35) echo 'selected';?>>FINANCIAL AID - 070</option>
						<option value="36" <?php if($edit==1 && $dept==36) echo 'selected';?>>BIOLOGICAL SCIENCES - 080</option>
						<option value="37" <?php if($edit==1 && $dept==37) echo 'selected';?>>ADMISSIONS/ ENROLLMENT MANAGEMENT - 082</option>
						<option value="38" <?php if($edit==1 && $dept==38) echo 'selected';?>>NURSING - 086</option>
						<option value="39" <?php if($edit==1 && $dept==39) echo 'selected';?>>SUPERVISING TEACHERS (EDUCATION) - 092</option>
						-->
            ...
            <tr bgcolor="#F1F1F1">
            	...
            	<td colspan="2">
            		<input type="text" placeholder="xyz@latech.edu" onChange="getNameFromLDAP('supervisor_email')" name="supervisor_email" id="supervisor_email" <? if($edit==1 || $csv_input==1) echo "value=\"$supervisor_email\" "; ?>>
                    <div>Tech E-mail</div>
            	</td>
            	<td colspan="2">
		...
		<div class="darker_row">
			<table cellpadding="5" cellspacing="0" border="0" width="100%" id="sal1_tb">	
				...
				<tr>
					<td><input type="text" name="monthly_amt" id="monthly_amt" <? if($edit==1) echo "value=\"$amt[1]\" "; ?> onBlur="this.value=formatCurrency(this.value);calculateYearlySalary();checkForWarnings();checkMinimumWage();" >
					<div>Monthly</div></td>
					...
					<div>Base</div></td>
					<td colspan="2" valign="top"><input type="text" readonly="readonly" name="req_sal" id="req_sal" <? if($edit==1 || $csv_input==1) echo "value=\"$req_sal\" "; ?> onBlur="this.value=formatCurrency(this.value)" ></td>
				</tr>	
				<tr>
...
*/ ?>
		...
		<table style="padding-bottom: 25px;" cellspacing="0" cellpadding="5" border="0" width="100%" class="darker_row" id="major_time_dates_table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    	<input type="text" onchange="checkForWarnings();checkForOverlap();" name="major_time_from" id="major_time_from" <?if($edit==1) echo "value=\"$major_time_from\" "; ?> class="dp">
                    </td>
                    <td align="right">
                    	To:
                    </td>
                ...
                <tr>
                	<td colspan="4"><div id="warning_messages"></div></td>
                </tr>
         	</tbody>
        </table>
        ...
        <table cellspacing="0" cellpadding="5" border="0" width="100%" id="details_tb">
            ...
            if($edit!=1){ ?>	
                <tr>
                    ...
                    <td><input type="text" readonly name="major_fund[]" id="major_fund" onBlur="this.value=formatCurrency(this.value);updateTotalfund();"></td>
                </tr>
            <?php
            }
            if($edit==1){
            ...
            ?>
                <tr>	
                    ...
                    <td><input type="text" readonly name="major_fund[]" id="major_fund_<? echo $count ?>" <? echo "value=\"$major_funds[$count]\" "; ?> onBlur="this.value=formatCurrency(this.value);updateTotalfund();"></td>
                </tr>
                <?php
                }
			} ?>
		...
		<div class="darker_row">
			<table cellspacing="0" cellpadding="5" border="0" width="100%">
				...
				<tr>
					<td><input type="text" name="prepared_by" readonly="readonly" id="prepared_by" value="<? echo $prepared_by ?>" /></td>
				</tr>
			</table>
		</div>
